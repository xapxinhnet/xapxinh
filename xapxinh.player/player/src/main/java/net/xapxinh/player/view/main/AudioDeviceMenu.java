...
import net.xapxinh.player.view.action.mediaplayer.AudioDeviceAction;
...
public final class AudioDeviceMenu extends OnDemandMenu {
    ...
    protected void onPrepareMenu(JMenu menu) {
        String audioDeviceId = application().mediaPlayerPanel().getMediaPlayer().getAudioOutputDevice();
