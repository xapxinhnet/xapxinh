...
public final class MediaPlayerActions {
    ...
    private List<Action> newAudioControlActions(MediaPlayer mediaPlayer) {
        List<Action> actions = new ArrayList<>();
        actions.add(new VolumeAction(resource("menu.audio.item.increaseVolume"), mediaPlayer,  5));
        actions.add(new VolumeAction(resource("menu.audio.item.decreaseVolume"), mediaPlayer, -5));
