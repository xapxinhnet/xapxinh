...
package net.xapxinh.player.view.effects;
...
import net.xapxinh.player.view.effects.audio.AudioEffectsPanel;
import net.xapxinh.player.view.effects.video.VideoEffectsPanel;
